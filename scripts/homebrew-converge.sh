...
BREWFILE="$PROJECT_ROOT/packages/macos/Brewfile"
TRUSTED_FORMULAE_FILE="$PROJECT_ROOT/packages/macos/trusted-formulae.txt"
PROTECTED_FILE="$PROJECT_ROOT/packages/macos/protected-packages.txt"
